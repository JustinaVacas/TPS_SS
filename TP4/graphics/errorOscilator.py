...
if __name__ == '__main__':
   ...
   # errorB3 = parseParameters(sys.argv[21])
    ...
    errorsV = [errorV4, errorV5, errorV6, errorV7, errorV8, errorV9]
    errorsG = [errorG4, errorG5, errorG6, errorG7, errorG8, errorG9]
    errorsB = [errorB4, errorB5, errorB6, errorB7, errorB8, errorB9]
