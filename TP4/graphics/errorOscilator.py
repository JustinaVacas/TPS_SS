...
def draw(deltas, errorsB):

    # plt.plot(deltas, errorsV, "o-", label="Verlet")
    plt.plot(deltas, errorsB, "o-", label="Beeman")
...
if __name__ == '__main__':
    deltas = [0.005, 0.001, 0.0005, 0.0001, 0.00005, 0.00001]
    ...
    errorB1 = parseParameters(sys.argv[1])
    errorB2 = parseParameters(sys.argv[2])
    errorB3 = parseParameters(sys.argv[3])
    errorB4 = parseParameters(sys.argv[4])
    errorB5 = parseParameters(sys.argv[5])
    errorB6 = parseParameters(sys.argv[6])
    ...
    errorsB = [errorB1, errorB2, errorB3, errorB4, errorB5, errorB6]
