...
if __name__ == '__main__':
    ...
    # #10
    time10_1, fz10_1 = parseParameters(sys.argv[4])
    time10_2, fz10_2 = parseParameters(sys.argv[5])
    time10_3, fz10_3 = parseParameters(sys.argv[6])
    avgTime10 = mean([fz10_1[-1], fz10_2[-1], fz10_3[-1]])
    desvioTime10 = np.std([fz10_1[-1], fz10_2[-1], fz10_3[-1]])
    #40
    time40_1, fz40_1 = parseParameters(sys.argv[7])
    time40_2, fz40_2 = parseParameters(sys.argv[8])
    time40_3, fz40_3 = parseParameters(sys.argv[9])
    avgTime40 = mean([fz40_1[-1], fz40_2[-1], fz40_3[-1]])
    desvioTime40 = np.std([fz40_1[-1], fz40_2[-1], fz40_3[-1]])
    #80
    time80_1, fz80_1 = parseParameters(sys.argv[10])
    time80_2, fz80_2 = parseParameters(sys.argv[11])
    time80_3, fz80_3 = parseParameters(sys.argv[12])
    avgTime80 = mean([fz80_1[-1], fz80_2[-1], fz80_3[-1]])
    desvioTime80 = np.std([fz80_1[-1], fz80_2[-1], fz80_3[-1]])
    #140
    time140_1, fz140_1 = parseParameters(sys.argv[13])
    time140_2, fz140_2 = parseParameters(sys.argv[14])
    time140_3, fz140_3 = parseParameters(sys.argv[15])
    avgTime140 = mean([fz140_1[-1], fz140_2[-1], fz140_3[-1]])
    desvioTime140 = np.std([fz140_1[-1], fz140_2[-1], fz140_3[-1]])
    #200
    time200_1, fz200_1 = parseParameters(sys.argv[16])
    time200_2, fz200_2 = parseParameters(sys.argv[17])
    time200_3, fz200_3 = parseParameters(sys.argv[18])
    avgTime200 = mean([fz200_1[-1], fz200_2[-1], fz200_3[-1]])
    desvioTime200 = np.std([fz200_1[-1], fz200_2[-1], fz200_3[-1]])
    #260
    time260_1, fz260_1 = parseParameters(sys.argv[19])
    time260_2, fz260_2 = parseParameters(sys.argv[20])
    time260_3, fz260_3 = parseParameters(sys.argv[21])
    avgTime260 = mean([fz260_1[-1], fz260_2[-1], fz260_3[-1]])
    desvioTime260 = np.std([fz260_1[-1], fz260_2[-1], fz260_3[-1]])
    #320
    time320_1, fz320_1 = parseParameters(sys.argv[22])
    time320_2, fz320_2 = parseParameters(sys.argv[23])
    time320_3, fz320_3 = parseParameters(sys.argv[24])
    avgTime320 = mean([fz320_1[-1], fz320_2[-1], fz320_3[-1]])
    desvioTime320 = np.std([fz320_1[-1], fz320_2[-1], fz320_3[-1]])


    draw([avgTime2,desvioTime2],[avgTime10,desvioTime10],[avgTime40,desvioTime40],[avgTime80,desvioTime80],[avgTime140,desvioTime140], [avgTime200, desvioTime200],[avgTime260, desvioTime260], [avgTime320, desvioTime320])
