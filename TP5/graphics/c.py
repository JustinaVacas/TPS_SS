...
def draw(fp1, fp2, fp3, fp4, fp5, fp6, fp7, fp8, fp9,aux):
    ...
    ax.set(xlim=(0.5, 5.5), xticks=x,
           ylim=(-0.1, 1.1), yticks=np.arange(0, 1.1, 0.1))
...
def drawTime(fp1, fp2, fp3, fp4, fp5):
    plt.rcParams.update({'font.size': 12})
    # plt.rcParams["figure.figsize"] = (20,3)
    ...
    # promedio
    y = [fp1[0], fp2[0], fp3[0], fp4[0], fp5[0]]

    # desvio estandar
    yerr = [fp1[1], fp2[1], fp3[1], fp4[1], fp5[1]]
    ...
    ax.set(xlim=(2.5, 5.5), xticks=x,
           ylim=(80, 190), yticks=np.arange(60, 190, 20))
...
if __name__ == '__main__':
    ...
    # 3
    # 144.9625000000051	191.0	201.0
    # 131.4375000000174	189.0	201.0
    # 183.07499999997043	185.0	201.0
    avg3 = mean([144.9625000000051, 131.4375000000174, 183.07499999997043])
    desvio3 = np.std([144.9625000000051, 131.4375000000174, 183.07499999997043])

    # 3.5
    # 158.08749999999316	191.0	201.0
    # 132.71250000001623	191.0	201.0
    # 131.90000000001697	183.0	201.0
    avg35 = mean([158.08749999999316, 132.71250000001623, 131.90000000001697])
    desvio35 = np.std([158.08749999999316, 132.71250000001623, 131.90000000001697])

    # 4
    # 104.13750000001511	181.0	201.0
    # 110.21250000001649	187.0	201.0
    # 98.67500000001387	195.0	201.0
    avg4 = mean([104.13750000001511, 110.21250000001649, 98.67500000001387])
    desvio4 = np.std([104.13750000001511, 110.21250000001649, 98.67500000001387])

    # 4.5
    # 81.40000000000994	185.0	201.0
    # 77.275000000009	181.0	201.0
    # 79.20000000000944	185.0	201.0
    avg45 = mean([81.40000000000994, 77.275000000009, 79.20000000000944])
    desvio45 = np.std([81.40000000000994, 77.275000000009, 79.20000000000944])

    # 5
    # 83.13750000001033	167.0	201.0
    # 73.91250000000824	175.0	201.0
    # 80.60000000000976	185.0	201.0
    avg5 = mean([83.13750000001033, 73.91250000000824, 80.60000000000976])
    desvio5 = np.std([83.13750000001033, 73.91250000000824, 80.60000000000976])

    drawTime([avg3, desvio3], [avg35, desvio35], [avg4, desvio4], [avg45, desvio45],[avg5, desvio5])
