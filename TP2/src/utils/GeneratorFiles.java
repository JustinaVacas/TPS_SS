...
public class GeneratorFiles {
    ...
    public static void main(String[] args) {
        try {
            FileWriter myWriter = new FileWriter("./dynamic1_5.txt");
            myWriter.write("   0\n");
            for(int i=0; i < N; i++){
            ...
            myWriter.close();
            System.out.println("Successfully wrote dynamic1_5.txt");
        } catch (IOException e) {
        ...
        try {
            ...
            FileWriter myWriter = new FileWriter("./static1_5.txt");
            myWriter.write("   " + N + "\n");
            myWriter.write("   " + L + "\n");
            myWriter.write("   " + n + "\n");
            for(int i = 0; i < N; i++){
            ...
            myWriter.close();
            System.out.println("Successfully wrote static1_5.txt");
        } catch (IOException e) {
            System.out.println("An error occurred.");
            e.printStackTrace();
        }
