...
public class GeneratorFiles {
    ...
    public static void main(String[] args) {
        try {
            FileWriter myWriter = new FileWriter("./dynamic3_5.txt");
            myWriter.write("   0\n");
            for(int i=0; i < N; i++){
            ...
            myWriter.close();
            System.out.println("Successfully wrote dynamic3_5.txt");
        } catch (IOException e) {
        ...
        try {
            ...
            FileWriter myWriter = new FileWriter("./static3_5.txt");
            myWriter.write("   " + N + "\n");
            myWriter.write("   " + L + "\n");
            myWriter.write("   " + n + "\n");
            for(int i = 0; i < N; i++){
            ...
            myWriter.close();
            System.out.println("Successfully wrote static3_5.txt");
        } catch (IOException e) {
            System.out.println("An error occurred.");
            e.printStackTrace();
        }
    ...
    public static void output(List<Double> orders){
        try {
            FileWriter myWriter = new FileWriter("./orders3_5.txt");
            for (Double order: orders) {
                myWriter.write(String.valueOf(order)+'\n');
            }
            myWriter.close();
            System.out.println("Successfully wrote orders3_5.txt");
        } catch (IOException e) {
            System.out.println("An error occurred.");
            e.printStackTrace();
        }
    ...
    public static void outputFrames(List<ArrayList<Double>> frames){
        try {
            FileWriter myWriter = new FileWriter("./frames3_5.txt");
            int frameNum = 0;
            int count = 0;
            for (ArrayList<Double> frame : frames) {
                if(count == 0){
                    ...
                    frameNum++; //frame=1
                    System.out.println("count: " + count + "frame " + frameNum);
                    count = 0;
                }
                if(count == N){
                    myWriter.write(String.valueOf(frameNum)+'\n');
            ...
            myWriter.close();
            System.out.println("Successfully wrote frames3_5.txt.");
        } catch (IOException e) {
            System.out.println("An error occurred.");
            e.printStackTrace();
        }
