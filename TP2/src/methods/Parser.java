...
public class Parser {
    public static void ParseParameters(String static100, String dynamic100, double r_max, ArrayList<Particle> birdsArray){
        // STATIC
        try {
            ...
            if (myReaderStatic.hasNextLine()) {
                String data = myReaderStatic.nextLine();
                data = data.replaceAll(" ", "");
                Simulator.n = Double.parseDouble(data);
            }
            ...
            while (myReaderStatic.hasNextLine()) {
                ...
                double angle = Double.parseDouble(dataStatic[2]);
                Particle particle = new Particle(id,radio,velocidad,angle);
                Simulator.birdsArray.add(particle);
                id++;
